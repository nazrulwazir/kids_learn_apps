...
views.get("btn_number").vw.setLeft((int)((40d / 100 * height)));
views.get("btn_number").vw.setTop((int)((60d / 100 * height) - (views.get("btn_number").vw.getHeight())));

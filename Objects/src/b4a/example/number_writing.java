...
public class number_writing extends Activity implements B4AActivity{
	public static number_writing mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.number_writing");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (number_writing).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.number_writing");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.number_writing", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (number_writing) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (number_writing) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (number_writing) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 113;BA.debugLine="If MediaPlayer1.IsPlaying Then MediaPlayer1.Pause";
if (_mediaplayer1.IsPlaying()) { 
_mediaplayer1.Pause();};
 //BA.debugLineNum = 114;BA.debugLine="timer1.Enabled = False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 115;BA.debugLine="MediaPlayer1.Looping = True";
_mediaplayer1.setLooping(anywheresoftware.b4a.keywords.Common.True);
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 106;BA.debugLine="MediaPlayer1.Play";
_mediaplayer1.Play();
 //BA.debugLineNum = 107;BA.debugLine="timer1.Enabled = True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 108;BA.debugLine="timer1_Tick 'don't wait one second for the UI to";
_timer1_tick();
 //BA.debugLineNum = 109;BA.debugLine="MediaPlayer1.Looping = True";
_mediaplayer1.setLooping(anywheresoftware.b4a.keywords.Common.True);
...
public static String  _b3_click() throws Exception{
 ...
 //BA.debugLineNum = 138;BA.debugLine="a1.Play";
mostCurrent._a1.Play();
 //BA.debugLineNum = 140;BA.debugLine="fv1.cleanPage";
mostCurrent._fv1.cleanPage();
 //BA.debugLineNum = 141;BA.debugLine="i3.Visible=False";
mostCurrent._i3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 142;BA.debugLine="i2.Visible=False";
mostCurrent._i2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 143;BA.debugLine="i4.Visible=False";
mostCurrent._i4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 144;BA.debugLine="i5.Visible=False";
mostCurrent._i5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 145;BA.debugLine="i6.Visible=False";
mostCurrent._i6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 146;BA.debugLine="i7.Visible=False";
mostCurrent._i7.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 147;BA.debugLine="i8.Visible=False";
mostCurrent._i8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 148;BA.debugLine="i9.Visible=False";
mostCurrent._i9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 149;BA.debugLine="i10.Visible=False";
mostCurrent._i10.setVisible(anywheresoftware.b4a.keywords.Common.False);
...
public static String  _btn_clear_click() throws Exception{
 //BA.debugLineNum = 363;BA.debugLine="Sub btn_clear_Click";
 //BA.debugLineNum = 364;BA.debugLine="fv1.cleanPage";
mostCurrent._fv1.cleanPage();
 //BA.debugLineNum = 365;BA.debugLine="End Sub";
return "";
}
public static String  _btnb_click() throws Exception{
 //BA.debugLineNum = 158;BA.debugLine="Sub btnB_Click";
 //BA.debugLineNum = 160;BA.debugLine="a2.Play";
mostCurrent._a2.Play();
 //BA.debugLineNum = 161;BA.debugLine="fv1.cleanPage";
mostCurrent._fv1.cleanPage();
 //BA.debugLineNum = 164;BA.debugLine="i1.Visible=False";
mostCurrent._i1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 165;BA.debugLine="i3.Visible=False";
mostCurrent._i3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 166;BA.debugLine="i4.Visible=False";
mostCurrent._i4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 167;BA.debugLine="i5.Visible=False";
mostCurrent._i5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 168;BA.debugLine="i6.Visible=False";
mostCurrent._i6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 169;BA.debugLine="i7.Visible=False";
mostCurrent._i7.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 170;BA.debugLine="i8.Visible=False";
mostCurrent._i8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 171;BA.debugLine="i9.Visible=False";
mostCurrent._i9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 172;BA.debugLine="i10.Visible=False";
mostCurrent._i10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 174;BA.debugLine="i2.Visible=True";
...
public static String  _btnc_click() throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Sub btnC_Click";
 //BA.debugLineNum = 183;BA.debugLine="a3.Play";
mostCurrent._a3.Play();
 //BA.debugLineNum = 184;BA.debugLine="fv1.cleanPage";
mostCurrent._fv1.cleanPage();
 //BA.debugLineNum = 188;BA.debugLine="i1.Visible=False";
mostCurrent._i1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 189;BA.debugLine="i2.Visible=False";
mostCurrent._i2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 190;BA.debugLine="i4.Visible=False";
mostCurrent._i4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 191;BA.debugLine="i5.Visible=False";
mostCurrent._i5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 192;BA.debugLine="i6.Visible=False";
mostCurrent._i6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 193;BA.debugLine="i7.Visible=False";
mostCurrent._i7.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 194;BA.debugLine="i8.Visible=False";
mostCurrent._i8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 195;BA.debugLine="i9.Visible=False";
mostCurrent._i9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 196;BA.debugLine="i10.Visible=False";
mostCurrent._i10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 198;BA.debugLine="i3.Visible=True";
...
public static String  _btnd_click() throws Exception{
 //BA.debugLineNum = 205;BA.debugLine="Sub btnD_Click";
 //BA.debugLineNum = 207;BA.debugLine="a4.Play";
mostCurrent._a4.Play();
 //BA.debugLineNum = 208;BA.debugLine="fv1.cleanPage";
mostCurrent._fv1.cleanPage();
 //BA.debugLineNum = 210;BA.debugLine="i1.Visible=False";
mostCurrent._i1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 211;BA.debugLine="i2.Visible=False";
mostCurrent._i2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 212;BA.debugLine="i3.Visible=False";
mostCurrent._i3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 213;BA.debugLine="i5.Visible=False";
mostCurrent._i5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 214;BA.debugLine="i6.Visible=False";
mostCurrent._i6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 215;BA.debugLine="i7.Visible=False";
mostCurrent._i7.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 216;BA.debugLine="i8.Visible=False";
mostCurrent._i8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 217;BA.debugLine="i9.Visible=False";
mostCurrent._i9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 218;BA.debugLine="i10.Visible=False";
mostCurrent._i10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 220;BA.debugLine="i4.Visible=True";
...
public static String  _btne_click() throws Exception{
 //BA.debugLineNum = 227;BA.debugLine="Sub btnE_Click";
 //BA.debugLineNum = 228;BA.debugLine="a5.Play";
mostCurrent._a5.Play();
 //BA.debugLineNum = 229;BA.debugLine="fv1.cleanPage";
mostCurrent._fv1.cleanPage();
 //BA.debugLineNum = 232;BA.debugLine="i1.Visible=False";
mostCurrent._i1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 233;BA.debugLine="i2.Visible=False";
mostCurrent._i2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 234;BA.debugLine="i3.Visible=False";
mostCurrent._i3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 235;BA.debugLine="i4.Visible=False";
mostCurrent._i4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 236;BA.debugLine="i6.Visible=False";
mostCurrent._i6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 237;BA.debugLine="i7.Visible=False";
mostCurrent._i7.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 238;BA.debugLine="i8.Visible=False";
mostCurrent._i8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 239;BA.debugLine="i9.Visible=False";
mostCurrent._i9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 240;BA.debugLine="i10.Visible=False";
mostCurrent._i10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 242;BA.debugLine="i5.Visible=True";
...
public static String  _btnf_click() throws Exception{
 //BA.debugLineNum = 250;BA.debugLine="Sub btnF_Click";
 //BA.debugLineNum = 252;BA.debugLine="a10.Play";
mostCurrent._a10.Play();
 //BA.debugLineNum = 255;BA.debugLine="fv1.cleanPage";
mostCurrent._fv1.cleanPage();
 //BA.debugLineNum = 257;BA.debugLine="i1.Visible=False";
mostCurrent._i1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 258;BA.debugLine="i2.Visible=False";
mostCurrent._i2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 259;BA.debugLine="i3.Visible=False";
mostCurrent._i3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 260;BA.debugLine="i4.Visible=False";
mostCurrent._i4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 261;BA.debugLine="i5.Visible=False";
mostCurrent._i5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 262;BA.debugLine="i7.Visible=False";
mostCurrent._i7.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 263;BA.debugLine="i8.Visible=False";
mostCurrent._i8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 264;BA.debugLine="i9.Visible=False";
mostCurrent._i9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 265;BA.debugLine="i10.Visible=False";
mostCurrent._i10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 267;BA.debugLine="i6.Visible=True";
...
public static String  _btng_click() throws Exception{
 //BA.debugLineNum = 274;BA.debugLine="Sub btnG_Click";
 //BA.debugLineNum = 275;BA.debugLine="a6.Play";
mostCurrent._a6.Play();
 //BA.debugLineNum = 276;BA.debugLine="fv1.cleanPage";
mostCurrent._fv1.cleanPage();
 //BA.debugLineNum = 277;BA.debugLine="i1.Visible=False";
mostCurrent._i1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 278;BA.debugLine="i2.Visible=False";
mostCurrent._i2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 279;BA.debugLine="i3.Visible=False";
mostCurrent._i3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 280;BA.debugLine="i4.Visible=False";
mostCurrent._i4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 281;BA.debugLine="i5.Visible=False";
mostCurrent._i5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 282;BA.debugLine="i6.Visible=False";
mostCurrent._i6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 283;BA.debugLine="i8.Visible=False";
mostCurrent._i8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 284;BA.debugLine="i9.Visible=False";
mostCurrent._i9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 285;BA.debugLine="i10.Visible=False";
mostCurrent._i10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 287;BA.debugLine="i7.Visible=True";
...
public static String  _btnh_click() throws Exception{
 //BA.debugLineNum = 294;BA.debugLine="Sub btnH_Click";
 //BA.debugLineNum = 295;BA.debugLine="a7.Play";
mostCurrent._a7.Play();
 //BA.debugLineNum = 296;BA.debugLine="fv1.cleanPage";
mostCurrent._fv1.cleanPage();
 //BA.debugLineNum = 297;BA.debugLine="i1.Visible=False";
mostCurrent._i1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 298;BA.debugLine="i2.Visible=False";
mostCurrent._i2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 299;BA.debugLine="i3.Visible=False";
mostCurrent._i3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 300;BA.debugLine="i4.Visible=False";
mostCurrent._i4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 301;BA.debugLine="i5.Visible=False";
mostCurrent._i5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 302;BA.debugLine="i6.Visible=False";
mostCurrent._i6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 303;BA.debugLine="i7.Visible=False";
mostCurrent._i7.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 304;BA.debugLine="i9.Visible=False";
mostCurrent._i9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 305;BA.debugLine="i10.Visible=False";
mostCurrent._i10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 307;BA.debugLine="i8.Visible=True";
...
public static String  _btni_click() throws Exception{
 //BA.debugLineNum = 314;BA.debugLine="Sub btnI_Click";
 //BA.debugLineNum = 315;BA.debugLine="a8.Play";
mostCurrent._a8.Play();
 //BA.debugLineNum = 316;BA.debugLine="fv1.cleanPage";
mostCurrent._fv1.cleanPage();
 //BA.debugLineNum = 317;BA.debugLine="i1.Visible=False";
mostCurrent._i1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 318;BA.debugLine="i2.Visible=False";
mostCurrent._i2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 319;BA.debugLine="i3.Visible=False";
mostCurrent._i3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 320;BA.debugLine="i4.Visible=False";
mostCurrent._i4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 321;BA.debugLine="i5.Visible=False";
mostCurrent._i5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 322;BA.debugLine="i6.Visible=False";
mostCurrent._i6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 323;BA.debugLine="i7.Visible=False";
mostCurrent._i7.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 324;BA.debugLine="i8.Visible=False";
mostCurrent._i8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 325;BA.debugLine="i10.Visible=False";
mostCurrent._i10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 327;BA.debugLine="i9.Visible=True";
...
public static String  _btnj_click() throws Exception{
 //BA.debugLineNum = 334;BA.debugLine="Sub btnJ_Click";
 //BA.debugLineNum = 335;BA.debugLine="a9.Play";
mostCurrent._a9.Play();
 //BA.debugLineNum = 336;BA.debugLine="fv1.cleanPage";
mostCurrent._fv1.cleanPage();
 //BA.debugLineNum = 337;BA.debugLine="i1.Visible=False";
mostCurrent._i1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 338;BA.debugLine="i2.Visible=False";
mostCurrent._i2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 339;BA.debugLine="i3.Visible=False";
mostCurrent._i3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 340;BA.debugLine="i4.Visible=False";
mostCurrent._i4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 341;BA.debugLine="i5.Visible=False";
mostCurrent._i5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 342;BA.debugLine="i6.Visible=False";
mostCurrent._i6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 343;BA.debugLine="i7.Visible=False";
mostCurrent._i7.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 344;BA.debugLine="i8.Visible=False";
mostCurrent._i8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 345;BA.debugLine="i9.Visible=False";
mostCurrent._i9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 347;BA.debugLine="i10.Visible=True";
...
int _seconds = 0;
int _minutes = 0;
 //BA.debugLineNum = 126;BA.debugLine="Sub ConvertToTimeFormat(ms As Int) As String";
 //BA.debugLineNum = 127;BA.debugLine="Dim seconds, minutes As Int";
_seconds = 0;
_minutes = 0;
 //BA.debugLineNum = 128;BA.debugLine="seconds = Round(ms / 1000)";
_seconds = (int) (anywheresoftware.b4a.keywords.Common.Round(_ms/(double)1000));
 //BA.debugLineNum = 129;BA.debugLine="minutes = Floor(seconds / 60)";
_minutes = (int) (anywheresoftware.b4a.keywords.Common.Floor(_seconds/(double)60));
 //BA.debugLineNum = 130;BA.debugLine="seconds = seconds Mod 60";
_seconds = (int) (_seconds%60);
 //BA.debugLineNum = 131;BA.debugLine="Return NumberFormat(minutes, 1, 0) & \":\" & Number";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 19;BA.debugLine="Public a1,a2,a3,a4,a5,a6,a7,a8,a9,a10 As MediaPla";
...
mostCurrent._a10 = new anywheresoftware.b4a.objects.MediaPlayerWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Dim  introwel As MediaPlayer";
mostCurrent._introwel = new anywheresoftware.b4a.objects.MediaPlayerWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Dim b1,b2,b3,b4,b5,b6,b7 As Button";
...
mostCurrent._b7 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Dim i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i1";
...
mostCurrent._iplay = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 33;BA.debugLine="introwel.Initialize2(\"introwel\")";
...
mostCurrent._play_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 37;BA.debugLine="Private btn_clear As Button";
mostCurrent._btn_clear = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 39;BA.debugLine="Private fv1 As FabricView";
...
_clicksound = new anywheresoftware.b4a.objects.MediaPlayerWrapper();
 //BA.debugLineNum = 10;BA.debugLine="Public MediaPlayer1 As MediaPlayer";
...
public static String  _timer1_tick() throws Exception{
 //BA.debugLineNum = 118;BA.debugLine="Sub timer1_Tick";
 //BA.debugLineNum = 119;BA.debugLine="If MediaPlayer1.IsPlaying Then";
if (_mediaplayer1.IsPlaying()) { 
 };

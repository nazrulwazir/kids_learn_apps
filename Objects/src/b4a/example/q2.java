...
public class q2 extends Activity implements B4AActivity{
	public static q2 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.q2");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (q2).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.q2");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.q2", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (q2) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (q2) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (q2) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 76;BA.debugLine="Activity.LoadLayout(\"q2\")";
...
public static String  _btnnext_click() throws Exception{
 ...
 //BA.debugLineNum = 146;BA.debugLine="StartActivity(q3)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._q3.getObject()));
...
public static String  _btnspeak1_click() throws Exception{
 ...
 //BA.debugLineNum = 117;BA.debugLine="TTS.Speak(\" Ball \", True)";
_tts.Speak(" Ball ",anywheresoftware.b4a.keywords.Common.True);
...
mostCurrent._lbl1.setText((Object)("0"));
 ...
 //BA.debugLineNum = 132;BA.debugLine="clicksound.Play";
_clicksound.Play();
 //BA.debugLineNum = 133;BA.debugLine="Msgbox(\"Correct Answer is BALL\", \"Congrats\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Correct Answer is BALL","Congrats",mostCurrent.activityBA);
 //BA.debugLineNum = 134;BA.debugLine="lbl1.Text  =  \"1\"";
mostCurrent._lbl1.setText((Object)("1"));
 }else if(mostCurrent._rb4.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 136;BA.debugLine="clicksound2.Play";
_clicksound2.Play();
 //BA.debugLineNum = 137;BA.debugLine="Msgbox(\"Try Again\", \"Wrong\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Try Again","Wrong",mostCurrent.activityBA);
 //BA.debugLineNum = 138;BA.debugLine="lbl1.Text  =  \"0\"";
mostCurrent._lbl1.setText((Object)("0"));
 };

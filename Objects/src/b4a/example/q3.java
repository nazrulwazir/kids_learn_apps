...
public class q3 extends Activity implements B4AActivity{
	public static q3 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.q3");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (q3).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.q3");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.q3", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (q3) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (q3) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (q3) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 76;BA.debugLine="Activity.LoadLayout(\"q3\")";
mostCurrent._activity.LoadLayout("q3",mostCurrent.activityBA);
 //BA.debugLineNum = 77;BA.debugLine="TTS.Initialize(\"tts\")";
_tts.Initialize(processBA,"tts");
 //BA.debugLineNum = 79;BA.debugLine="MediaPlayer1.Initialize( )";
_mediaplayer1.Initialize();
 //BA.debugLineNum = 80;BA.debugLine="MediaPlayer1.Load(File.DirAssets, \"intro.mp3\")";
_mediaplayer1.Load(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"intro.mp3");
 //BA.debugLineNum = 81;BA.debugLine="timer1.Initialize(\"timer1\", 1000)";
mostCurrent._timer1.Initialize(processBA,"timer1",(long) (1000));
 //BA.debugLineNum = 82;BA.debugLine="MediaPlayer1.Looping = True";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 94;BA.debugLine="If MediaPlayer1.IsPlaying Then MediaPlayer1.Pause";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 87;BA.debugLine="MediaPlayer1.Play";
_mediaplayer1.Play();
 //BA.debugLineNum = 88;BA.debugLine="timer1.Enabled = True";
mostCurrent._timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 89;BA.debugLine="timer1_Tick 'don't wait one second for the UI to";
_timer1_tick();
 //BA.debugLineNum = 90;BA.debugLine="MediaPlayer1.Looping = True";
_mediaplayer1.setLooping(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 91;BA.debugLine="End Sub";
return "";
}
public static String  _btnnext_click() throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Sub btnNext_Click";
 //BA.debugLineNum = 144;BA.debugLine="StartActivity(q4)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._q4.getObject()));
 //BA.debugLineNum = 145;BA.debugLine="End Sub";
return "";
}
public static String  _btnprev_click() throws Exception{
 //BA.debugLineNum = 148;BA.debugLine="Sub btnPrev_Click";
...
public static String  _btnspeak1_click() throws Exception{
 //BA.debugLineNum = 114;BA.debugLine="Sub btnSpeak1_Click";
 //BA.debugLineNum = 115;BA.debugLine="TTS.Speak(\" Cat \", True)";
_tts.Speak(" Cat ",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 116;BA.debugLine="End Sub";
return "";
}
public static String  _btnsubmit_click() throws Exception{
 //BA.debugLineNum = 118;BA.debugLine="Sub btnSubmit_Click";
 //BA.debugLineNum = 121;BA.debugLine="If rb1.Checked = True Then";
if (mostCurrent._rb1.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 122;BA.debugLine="clicksound.Play";
_clicksound.Play();
 //BA.debugLineNum = 123;BA.debugLine="Msgbox(\"Correct Answer is CAT\", \"Congrats\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Correct Answer is CAT","Congrats",mostCurrent.activityBA);
 //BA.debugLineNum = 124;BA.debugLine="lbl1.Text  =  \"1\"";
mostCurrent._lbl1.setText((Object)("1"));
 }else if(mostCurrent._rb2.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 126;BA.debugLine="clicksound2.Play";
_clicksound2.Play();
 //BA.debugLineNum = 127;BA.debugLine="Msgbox(\"Try Again\", \"Wrong\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Try Again","Wrong",mostCurrent.activityBA);
 //BA.debugLineNum = 128;BA.debugLine="lbl1.Text  =  \"0\"";
mostCurrent._lbl1.setText((Object)("0"));
 }else if(mostCurrent._rb3.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 130;BA.debugLine="clicksound2.Play";
_clicksound2.Play();
 //BA.debugLineNum = 131;BA.debugLine="Msgbox(\"Try Again\", \"Wrong\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Try Again","Wrong",mostCurrent.activityBA);
 //BA.debugLineNum = 132;BA.debugLine="lbl1.Text  =  \"0\"";
mostCurrent._lbl1.setText((Object)("0"));
 }else if(mostCurrent._rb4.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 134;BA.debugLine="clicksound2.Play";
_clicksound2.Play();
 //BA.debugLineNum = 135;BA.debugLine="Msgbox(\"Try Again\", \"Wrong\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Try Again","Wrong",mostCurrent.activityBA);
 //BA.debugLineNum = 136;BA.debugLine="lbl1.Text  =  \"0\"";
mostCurrent._lbl1.setText((Object)("0"));
 };
...
int _seconds = 0;
int _minutes = 0;
 //BA.debugLineNum = 107;BA.debugLine="Sub ConvertToTimeFormat(ms As Int) As String";
 //BA.debugLineNum = 108;BA.debugLine="Dim seconds, minutes As Int";
_seconds = 0;
_minutes = 0;
 //BA.debugLineNum = 109;BA.debugLine="seconds = Round(ms / 1000)";
_seconds = (int) (anywheresoftware.b4a.keywords.Common.Round(_ms/(double)1000));
 //BA.debugLineNum = 110;BA.debugLine="minutes = Floor(seconds / 60)";
_minutes = (int) (anywheresoftware.b4a.keywords.Common.Floor(_seconds/(double)60));
 //BA.debugLineNum = 111;BA.debugLine="seconds = seconds Mod 60";
_seconds = (int) (_seconds%60);
 //BA.debugLineNum = 112;BA.debugLine="Return NumberFormat(minutes, 1, 0) & \":\" & Number";
...
public static String  _timer1_tick() throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Sub timer1_Tick";
 //BA.debugLineNum = 100;BA.debugLine="If MediaPlayer1.IsPlaying Then";
if (_mediaplayer1.IsPlaying()) { 
 };

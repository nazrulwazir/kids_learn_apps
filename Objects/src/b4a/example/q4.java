...
public class q4 extends Activity implements B4AActivity{
	public static q4 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.q4");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (q4).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.q4");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.q4", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (q4) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (q4) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (q4) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 77;BA.debugLine="Activity.LoadLayout(\"q4\")";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 96;BA.debugLine="If MediaPlayer1.IsPlaying Then MediaPlayer1.Pause";
...
mostCurrent._timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 98;BA.debugLine="MediaPlayer1.Looping = True";
_mediaplayer1.setLooping(anywheresoftware.b4a.keywords.Common.True);
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 89;BA.debugLine="MediaPlayer1.Play";
_mediaplayer1.Play();
...
mostCurrent._timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 91;BA.debugLine="timer1_Tick 'don't wait one second for the UI to";
_timer1_tick();
 //BA.debugLineNum = 92;BA.debugLine="MediaPlayer1.Looping = True";
_mediaplayer1.setLooping(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 93;BA.debugLine="End Sub";
return "";
}
public static String  _btnnext_click() throws Exception{
 //BA.debugLineNum = 146;BA.debugLine="Sub btnNext_Click";
 //BA.debugLineNum = 147;BA.debugLine="StartActivity(q5)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._q5.getObject()));
 //BA.debugLineNum = 148;BA.debugLine="End Sub";
return "";
}
public static String  _btnprev_click() throws Exception{
 //BA.debugLineNum = 151;BA.debugLine="Sub btnPrev_Click";
...
public static String  _btnspeak1_click() throws Exception{
 //BA.debugLineNum = 117;BA.debugLine="Sub btnSpeak1_Click";
 //BA.debugLineNum = 118;BA.debugLine="TTS.Speak(\" house \", True)";
_tts.Speak(" house ",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 119;BA.debugLine="End Sub";
return "";
}
public static String  _btnsubmit_click() throws Exception{
 //BA.debugLineNum = 121;BA.debugLine="Sub btnSubmit_Click";
 //BA.debugLineNum = 124;BA.debugLine="If rb1.Checked = True Then";
if (mostCurrent._rb1.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 125;BA.debugLine="clicksound2.Play";
_clicksound2.Play();
 //BA.debugLineNum = 126;BA.debugLine="Msgbox(\"Try Again\", \"Wrong\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Try Again","Wrong",mostCurrent.activityBA);
 //BA.debugLineNum = 127;BA.debugLine="lbl1.Text  =  \"0\"";
mostCurrent._lbl1.setText((Object)("0"));
 }else if(mostCurrent._rb2.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 129;BA.debugLine="clicksound2.Play";
_clicksound2.Play();
 //BA.debugLineNum = 130;BA.debugLine="Msgbox(\"Try Again\", \"Wrong\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Try Again","Wrong",mostCurrent.activityBA);
 //BA.debugLineNum = 131;BA.debugLine="lbl1.Text  =  \"0\"";
mostCurrent._lbl1.setText((Object)("0"));
 }else if(mostCurrent._rb3.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 133;BA.debugLine="clicksound2.Play";
_clicksound2.Play();
 //BA.debugLineNum = 134;BA.debugLine="Msgbox(\"Try Again\", \"Wrong\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Try Again","Wrong",mostCurrent.activityBA);
 //BA.debugLineNum = 135;BA.debugLine="lbl1.Text  =  \"0\"";
mostCurrent._lbl1.setText((Object)("0"));
 }else if(mostCurrent._rb4.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 137;BA.debugLine="clicksound.Play";
_clicksound.Play();
 //BA.debugLineNum = 138;BA.debugLine="Msgbox(\"Correct Answer is House\", \"Congrats\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Correct Answer is House","Congrats",mostCurrent.activityBA);
 //BA.debugLineNum = 139;BA.debugLine="lbl1.Text  =  \"1\"";
...
int _seconds = 0;
int _minutes = 0;
 //BA.debugLineNum = 109;BA.debugLine="Sub ConvertToTimeFormat(ms As Int) As String";
 //BA.debugLineNum = 110;BA.debugLine="Dim seconds, minutes As Int";
_seconds = 0;
_minutes = 0;
 //BA.debugLineNum = 111;BA.debugLine="seconds = Round(ms / 1000)";
_seconds = (int) (anywheresoftware.b4a.keywords.Common.Round(_ms/(double)1000));
 //BA.debugLineNum = 112;BA.debugLine="minutes = Floor(seconds / 60)";
_minutes = (int) (anywheresoftware.b4a.keywords.Common.Floor(_seconds/(double)60));
 //BA.debugLineNum = 113;BA.debugLine="seconds = seconds Mod 60";
_seconds = (int) (_seconds%60);
 //BA.debugLineNum = 114;BA.debugLine="Return NumberFormat(minutes, 1, 0) & \":\" & Number";
...
public static String  _timer1_tick() throws Exception{
 //BA.debugLineNum = 101;BA.debugLine="Sub timer1_Tick";
 //BA.debugLineNum = 102;BA.debugLine="If MediaPlayer1.IsPlaying Then";
if (_mediaplayer1.IsPlaying()) { 
 };

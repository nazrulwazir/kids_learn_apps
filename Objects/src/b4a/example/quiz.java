...
public class quiz extends Activity implements B4AActivity{
	public static quiz mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.quiz");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (quiz).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.quiz");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.quiz", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (quiz) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (quiz) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (quiz) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 75;BA.debugLine="Activity.LoadLayout(\"Test\")";
mostCurrent._activity.LoadLayout("Test",mostCurrent.activityBA);
 //BA.debugLineNum = 76;BA.debugLine="TTS.Initialize(\"tts\")";
...
public static String  _btnnext_click() throws Exception{
 ...
 //BA.debugLineNum = 145;BA.debugLine="StartActivity(q2)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._q2.getObject()));
 //BA.debugLineNum = 146;BA.debugLine="End Sub";
return "";
}
public static String  _btnspeak1_click() throws Exception{
 //BA.debugLineNum = 114;BA.debugLine="Sub btnSpeak1_Click";
 //BA.debugLineNum = 115;BA.debugLine="TTS.Speak(\" Heart \", True)";
_tts.Speak(" Heart ",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 116;BA.debugLine="End Sub";
return "";
}
public static String  _btnsubmit_click() throws Exception{
 //BA.debugLineNum = 119;BA.debugLine="Sub btnSubmit_Click";
 //BA.debugLineNum = 122;BA.debugLine="If rb1.Checked = True Then";
if (mostCurrent._rb1.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 123;BA.debugLine="clicksound2.Play";
_clicksound2.Play();
 //BA.debugLineNum = 124;BA.debugLine="Msgbox(\"Try Again\", \"Wrong\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Try Again","Wrong",mostCurrent.activityBA);
 //BA.debugLineNum = 125;BA.debugLine="lbl1.Text  =  \"0\"";
mostCurrent._lbl1.setText((Object)("0"));
 }else if(mostCurrent._rb2.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 127;BA.debugLine="clicksound.Play";
_clicksound.Play();
 //BA.debugLineNum = 128;BA.debugLine="Msgbox(\"Correct Answer is HEART\", \"Congrats\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Correct Answer is HEART","Congrats",mostCurrent.activityBA);
 //BA.debugLineNum = 129;BA.debugLine="lbl1.Text  =  \"1\"";
mostCurrent._lbl1.setText((Object)("1"));
 }else if(mostCurrent._rb3.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 131;BA.debugLine="clicksound2.Play";
_clicksound2.Play();
 //BA.debugLineNum = 132;BA.debugLine="Msgbox(\"Try Again\", \"Wrong\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Try Again","Wrong",mostCurrent.activityBA);
 //BA.debugLineNum = 133;BA.debugLine="lbl1.Text  =  \"0\"";
mostCurrent._lbl1.setText((Object)("0"));
 }else if(mostCurrent._rb4.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 135;BA.debugLine="clicksound2.Play";
_clicksound2.Play();
 //BA.debugLineNum = 136;BA.debugLine="Msgbox(\"Try Again\", \"Wrong\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Try Again","Wrong",mostCurrent.activityBA);
 //BA.debugLineNum = 137;BA.debugLine="lbl1.Text  =  \"0\"";
mostCurrent._lbl1.setText((Object)("0"));
 };
...
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 148;BA.debugLine="Sub Button2_Click";

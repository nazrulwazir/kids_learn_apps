...
public class video extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.video");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.video");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.video", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._vv.Initialize(mostCurrent.activityBA,"vv");
 //BA.debugLineNum = 24;BA.debugLine="Activity.AddView(vv, 10dip, 10dip, 600dip, 600dip)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._vv.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (600)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (600)));
 //BA.debugLineNum = 25;BA.debugLine="File.Exists(File.DirDefaultExternal, \"abc.mp4\")";
anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"abc.mp4");
 //BA.debugLineNum = 26;BA.debugLine="vv.LoadVideo(File.DirRootExternal, \"abc.mp4\")";
mostCurrent._vv.LoadVideo(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"abc.mp4");
 //BA.debugLineNum = 27;BA.debugLine="vv.Play";
mostCurrent._vv.Play();
 //BA.debugLineNum = 28;BA.debugLine="Dim TargetDir As String = File.DirRootExternal";
_targetdir = anywheresoftware.b4a.keywords.Common.File.getDirRootExternal();
 //BA.debugLineNum = 29;BA.debugLine="If File.Exists(TargetDir, \"abc.mp4\") = False Th";
if (anywheresoftware.b4a.keywords.Common.File.Exists(_targetdir,"abc.mp4")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 30;BA.debugLine="File.Copy(File.DirAssets, \"abc.mp4\", TargetD";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"abc.mp4",_targetdir,"abc.mp4");
 };
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 15;BA.debugLine="Dim vv As VideoView";
mostCurrent._vv = new anywheresoftware.b4a.audio.VideoViewWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Dim Send As ImageView";

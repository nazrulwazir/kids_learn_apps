...
File.Exists(File.DirDefaultExternal, "upin3.mp4")
vv.LoadVideo(File.DirRootExternal, "upin3.mp4") 
vv.Play
   Dim TargetDir As String = File.DirRootExternal
   If File.Exists(TargetDir, "upin3.mp4") = False Then
      File.Copy(File.DirAssets, "upin3.mp4", TargetDir, "upin3.mp4")
   End If
   Return TargetDir

...
File.Exists(File.DirDefaultExternal, "upin2.mp4")
vv.LoadVideo(File.DirRootExternal, "upin2.mp4") 
vv.Play
   Dim TargetDir As String = File.DirRootExternal
   If File.Exists(TargetDir, "upin2.mp4") = False Then
      File.Copy(File.DirAssets, "upin2.mp4", TargetDir, "upin2.mp4")
   End If
   Return TargetDir
